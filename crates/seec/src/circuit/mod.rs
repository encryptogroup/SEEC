...
pub const BRISTOL_ADD_8: &'static str = circ_path!("int_add8_depth.bristol");
pub const BRISTOL_ADD_16: &'static str = circ_path!("int_add16_depth.bristol");
pub const BRISTOL_ADD_32: &'static str = circ_path!("int_add32_depth.bristol");
pub const BRISTOL_ADD_64: &'static str = circ_path!("int_add64_depth.bristol");
